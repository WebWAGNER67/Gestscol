<x-home-layout>
    <div class="flex flex-col gap-3" id="content">
        <h2 class="font-semibold text-center text-white text-7xl">Erreur 403</h2>
        <p class="text-2xl text-center text-white">Vous n'avez pas l'autorisation d'accéder à cette page</p>
